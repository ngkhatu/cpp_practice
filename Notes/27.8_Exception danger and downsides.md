- [Exception dangers and downsides](#exception-dangers-and-downsides)
  - [Cleaning up resources](#cleaning-up-resources)
  - [Exceptions and destructors](#exceptions-and-destructors)
  - [Performance concerns](#performance-concerns)
  - [So when should I use exceptions?](#so-when-should-i-use-exceptions)
...
We cover std::unique_ptr in lesson 22.5 -- std::unique_ptr.
