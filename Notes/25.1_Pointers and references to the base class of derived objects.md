- [Pointers and references to the base class of derived objects](#pointers-and-references-to-the-base-class-of-derived-objects)
  - [Pointers, references, and derived classes](#pointers-references-and-derived-classes)
  - [Use for pointers and references to base classes](#use-for-pointers-and-references-to-base-classes)
