- [Circular dependency issues with std::shared\_ptr, and std::weak\_ptr](#circular-dependency-issues-with-stdshared_ptr-and-stdweak_ptr)
  - [Circular references](#circular-references)
  - [A reductive case](#a-reductive-case)
  - [So what is std::weak\_ptr for anyway?](#so-what-is-stdweak_ptr-for-anyway)
  - [Using std::weak\_ptr](#using-stdweak_ptr)
  - [Avoiding dangling pointers with std::weak\_ptr](#avoiding-dangling-pointers-with-stdweak_ptr)
