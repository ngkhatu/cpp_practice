- [Passing and returning std::array](#passing-and-returning-stdarray)
...
The <mark>primary advantage of this method is that no copy of the array is ever made, so this is efficient.</mark>
