- [Pure virtual functions, abstract base classes, and interface classes](#pure-virtual-functions-abstract-base-classes-and-interface-classes)
  - [Pure virtual (abstract) functions and abstract base classes](#pure-virtual-abstract-functions-and-abstract-base-classes)
  - [A pure virtual function example](#a-pure-virtual-function-example)
  - [Pure virtual functions with definitions](#pure-virtual-functions-with-definitions)
  - [Interface classes](#interface-classes)
  - [Pure virtual functions and the virtual table](#pure-virtual-functions-and-the-virtual-table)
