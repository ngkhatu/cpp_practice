- [std::shared\_ptr](#stdshared_ptr)
  ...
  - [Digging into std::shared\_ptr](#digging-into-stdshared_ptr)
  - [Shared pointers can be created from unique pointers](#shared-pointers-can-be-created-from-unique-pointers)
  - [The perils of std::shared\_ptr](#the-perils-of-stdshared_ptr)
  - [std::shared\_ptr and arrays](#stdshared_ptr-and-arrays)
